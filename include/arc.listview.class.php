...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class=\"page-item\"><a class=\"page-link\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'><i class=\"fa fa-angle-left\"></i>上一页</a></li>\r\n";
            $indexpage="<li><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></li>\r\n";
        }
        else
        {
            $prepage.="<li class=\"page-item disabled\"><a class=\"page-link\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a></li>\r\n";
            $indexpage="<li>首页</li>\r\n";
        }
        ...
        {
            $nextpage.="<li class=\"page-item\"><a class=\"page-link\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'><i class=\"fa fa-angle-right\"></i>下一页</a></li>\r\n";
            $endpage="<li><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></li>\r\n";
        }
        else
        {
            $nextpage.="<li class=\"page-item disabled\"><a class=\"page-link\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'><i class=\"fa fa-angle-left\"></i>下一页</a></li>\r\n";
            $endpage="<li>末页</li>\r\n";
        }
